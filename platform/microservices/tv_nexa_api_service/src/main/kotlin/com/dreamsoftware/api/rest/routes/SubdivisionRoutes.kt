 ...
 *
 * @property subdivisionController An instance of the [ISubdivisionController] interface for handling subdivision-related operations.
 */
fun Route.subdivisionRoutes() {
    val subdivisionController by inject<ISubdivisionController>()
    ...
    route("/subdivisions") {
         ...
         * Accepts GET requests to "/subdivisions/" and retrieves all subdivisions using the [subdivisionController.findAll] method.
        ...
        get("/") {
            call.generateSuccessResponse(
                ...
                data = subdivisionController.findAll()
            )
        }
         ...
         * using the [subdivisionController.findByCode] method.
            ...
            with(call) {
                doIfParamExists("subdivisionCode") { regionCode ->
                    generateSuccessResponse(
                        ...
                        data = subdivisionController.findByCode(regionCode)
                    )
                }
            }
        }
